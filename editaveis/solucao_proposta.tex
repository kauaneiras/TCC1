...
% Figura x: Diagrama de arquitetura da nuvem privada proposta
...
% Figura x: Screenshots do Horizon/Neutron
...
% Figura x: Diagrama do ciclo de vida de uma imagem de VM
...
% Figura x: Exemplo de política de escalonamento baseada em uso de CPU
