...
\begin{table}[H]
    ...
    % Colunas flexíveis que aceitam vários parágrafos/listas
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|p{5.1cm}|p{5.1cm}|c|}
    ...
    \hline
  \end{tabular}
  \fonte{Elaborado pelo autor, com base em \cite{techtarget2023, lee2021, snia2016}.}
\end{table}
...
\textbf{Vantagens}: altíssimo desempenho de leitura e escrita e excelente redundância; reconstrução rápida, pois apenas o par espelhado afetado precisa ser copiado \cite{techtarget2023}.
...
\section{Políticas Avançadas de Alocação}
